...
- Determine the user's intent (e.g., general_info, compatibility_check, upgrade_advice, install, remove, downgrade, etc.)
...
- For general information questions, use "general_info" intent
"""
